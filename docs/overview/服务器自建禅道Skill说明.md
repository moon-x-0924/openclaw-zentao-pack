...
- 技能包通知链路记录：`/root/.openclaw/workspace/skills/openclaw-zentao-pack/tmp/notification-audit/通知链路记录.md`
...
- 总览记录：`/root/.openclaw/workspace/skills/openclaw-zentao-pack/tmp/notification-audit/通知链路记录.md`
